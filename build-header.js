...
<svg width="${width}" height="${height}" viewBox="0 0 ${width} ${height}" xmlns="http://www.w3.org/2000/svg">
  <defs>
    ...
    <radialGradient id="nebula-cyan" cx="18%" cy="25%" r="60%">
      <stop offset="0%" stop-color="#00DFD8" stop-opacity="0.48" />
      <stop offset="50%" stop-color="#00DFD8" stop-opacity="0.14" />
      <stop offset="100%" stop-color="transparent" stop-opacity="0" />
    </radialGradient>
    
    <radialGradient id="nebula-purple" cx="82%" cy="75%" r="60%">
      <stop offset="0%" stop-color="#7701D0" stop-opacity="0.52" />
      <stop offset="50%" stop-color="#7701D0" stop-opacity="0.16" />
      <stop offset="100%" stop-color="transparent" stop-opacity="0" />
    </radialGradient>

    <radialGradient id="avatar-center-glow" cx="50%" cy="50%" r="50%">
      <stop offset="0%" stop-color="#00DFD8" stop-opacity="0.45" />
      <stop offset="45%" stop-color="#7701D0" stop-opacity="0.32" />
      <stop offset="100%" stop-color="transparent" stop-opacity="0" />
    </radialGradient>
    ...
    <style>
      ...
      .text-solid {
        ...
        letter-spacing: -3px;
        text-anchor: middle;
        filter: drop-shadow(0px 20px 40px rgba(0, 0, 0, 0.95)) drop-shadow(0px 0px 30px rgba(0, 223, 216, 0.35));
      }
      ...
      @keyframes glitch {
        0% { stroke-dashoffset: 0; stroke: rgba(255, 255, 255, 0.85); }
        ...
        60% { stroke-dashoffset: 10; transform: translate(-1px, 2px); stroke: rgba(255, 255, 255, 0.85); }
  ...
  <rect x="0" y="4" width="350" height="3" fill="url(#laser-flare-grad)">
  ...
  <circle cx="${width / 2}" cy="420" r="280" fill="url(#avatar-center-glow)" />

  <!-- Target Reticle Tick Aperture -->
  <g transform="translate(${width / 2}, 420)">
    <circle cx="0" cy="0" r="310" fill="none" stroke="rgba(0, 223, 216, 0.25)" stroke-width="1" stroke-dasharray="2, 8">
  ...
  <g>
    <ellipse cx="${width / 2}" cy="420" rx="320" ry="150" fill="none" stroke="rgba(0, 223, 216, 0.5)" stroke-width="1.6" stroke-dasharray="16, 12">
  ...
  <g>
    <ellipse cx="${width / 2}" cy="420" rx="270" ry="120" fill="none" stroke="rgba(168, 85, 247, 0.5)" stroke-width="1.4" stroke-dasharray="10, 14">
  ...
  <g>
    <ellipse cx="${width / 2}" cy="420" rx="290" ry="95" fill="none" stroke="rgba(16, 185, 129, 0.4)" stroke-width="1.2" stroke-dasharray="6, 8">
  ...
  <g>
    <ellipse cx="${width / 2}" cy="420" rx="240" ry="75" fill="none" stroke="rgba(245, 158, 11, 0.4)" stroke-width="1.2" stroke-dasharray="4, 6">
  ...
  <g transform="translate(38, 48)">
    ...
    <text x="28" y="26" class="hud-text-left" fill="#10B981">PORTFOLIO © 2026 // ONLINE</text>
    <text x="16" y="48" class="hud-text-left">[COLOMBO, SRI LANKA] • [UTC+5:30]</text>
    <text x="16" y="70" class="hud-text-left" fill="#00DFD8">SPEC: AI AGENTS • WEBGL 2.0 • KERNEL</text>
  ...
  <g transform="translate(${width - 406}, 48)">
    ...
    <text x="350" y="48" class="hud-text-right">INDEPENDENT CREATIVE &amp; ARCHITECT</text>
  ...
  <g transform="translate(${width / 2}, 60)">
    <line x1="-360" y1="-4" x2="-220" y2="-4" stroke="rgba(255,255,255,0.25)" stroke-width="1.2" />
    <text x="0" y="0" class="hud-text" fill="#00DFD8" style="font-size: 11.5px;">SOFTWARE ENGINEER (MATHIYA)<tspan class="cursor" fill="#00DFD8">_</tspan></text>
    <line x1="220" y1="-4" x2="360" y2="-4" stroke="rgba(255,255,255,0.25)" stroke-width="1.2" />
  </g>

  <!-- Layer 1: Bold Outlined Text (Behind Photo) -->
  <text x="${width / 2}" y="350" class="text-outline">MATHISHA</text>

  <!-- Layer 2: Center Image -->
  <g class="image-layer">
    <image href="${imageBase64}" x="${width / 2 - 270}" y="190" width="540" height="610" preserveAspectRatio="xMidYMax slice" />
  </g>
  ...
  <g transform="translate(${width / 2}, 835)">
    <line x1="-480" y1="0" x2="-330" y2="0" stroke="url(#chrome-border-grad)" stroke-width="1.4" />
    <text x="0" y="4" class="hud-text" fill="#00DFD8" style="letter-spacing: 6px;">SOFTWARE ENGINEER &amp; AI SYSTEMS ARCHITECT</text>
    <line x1="330" y1="0" x2="480" y2="0" stroke="url(#chrome-border-grad)" stroke-width="1.4" />
  </g>
        ...
        console.log("Created master dynamic animated header successfully!");
    });
});
